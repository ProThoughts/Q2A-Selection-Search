...
qa_register_plugin_layer('qa-selection-search-layer.php', 'Selection search');
//qa_register_plugin_module('module', 'qa-selection-search-admin-form.php', 'qa_selection_search_admin_form', 'Selection search');
